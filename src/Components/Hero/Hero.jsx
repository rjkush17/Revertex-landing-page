  ...
  return (
    <>
      <h1 className="headlines">
        We Develop <img src={star} className="star" alt="" /> <br />
        <span className="colored-text"> Amazing </span> Websites <br /> for your
        bussiness<span className="colored-text">.</span>
      </h1>
      ...
      <div className="hero-footer">
        <button id="button">View Work<FiArrowUpRight className='arrow'/></button>
